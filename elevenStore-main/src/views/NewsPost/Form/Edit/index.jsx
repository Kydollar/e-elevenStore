...
export default function FullWidthTabs() {
	...
	return (
		<Box sx={{ borderRadius: "8px" }} className="bg-white shadow-md mt-2">
			<div className="p-4 inline-flex w-full bg-gradient-to-br from-sky-700 to-sky-500 shadow-md rounded-t-lg text-white">
				<h1 className="font-bold">News</h1>
				<h6 className="text-sm mt-1 opacity-60">/Edit News</h6>
			</div>
			<AppBar
				position="static"
