...
import AddProductCategories from "./add";
...
export default function FullWidthTabs() {
	...
	return (
		<Box sx={{ borderRadius: "8px" }} className="bg-white shadow-md mt-2">
			<div className="p-4 bg-gradient-to-tr from-gray-800/30 to-blue-800/50 backdrop-blur-xl shadow-md rounded-t-lg text-white">
				<h1 className="font-bold">Product Category</h1>
				<h6 className="text-sm mt-1 opacity-60">Add Product Category</h6>
			</div>
			<AppBar
				position="static"
