                      ...
                      <TableCell key={column.id} align={column.align}>
                        ...
                        {column.id == "action" ? (
                          <div className="flex item-center justify-center">
                            <Link to={`${row.to}`} className="w-4 mx-1 transform hover:text-purple-500 hover:scale-110">
                              <ModeEditRoundedIcon alt="Edit User" />
                            </Link>
                            <Link onClick={() => handleDelete(row)} className="w-4 mx-1 transform hover:text-red-500 hover:scale-110">
