    ...
    <Link to={item?.to}>
      <div className={`${openSideBar && "mx-2 my-2"}`}>
        <ListItemButton
          ...
          selected={isActive}
        >
          <ListItemIcon className={`mr-4 py-3 rounded-xl shadow-lg ${openSideBar ? "justify-center" : "pl-2"} ${isActive ? "bg-gradient-to-tl from-gray-800/30 to-blue-800/50 !text-gray-100" : ""}`}>{item?.icon}</ListItemIcon>
    ...
    <React.Fragment>
      <div className={`${openSideBar && "mx-2 my-2"}`}>
        <ListItemButton
          ...
          selected={isActive}
        >
          <ListItemIcon className={`mr-4 py-3 rounded-xl shadow-lg ${openSideBar ? "justify-center" : "pl-2"} ${open ? "bg-gradient-to-tl from-gray-800/30 to-blue-800/50 !text-gray-100" : ""}`}>{item?.icon}</ListItemIcon>
          <ListItemText primary={item?.title} />
        ...
        setCategoryData([
          {
            ...
            items: response.data.map((ctg) => {
              return {
                ...
                title: ctg.productCategoryName.charAt(0).toUpperCase() + ctg.productCategoryName?.slice(1),
